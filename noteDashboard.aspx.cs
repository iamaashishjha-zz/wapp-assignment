...
namespace wapp
{
    public partial class noteDashboard : System.Web.UI.Page
    {
        ...
        protected void btnAddNotes_Click(object sender, EventArgs e)
        {
            ...
            //}
            //string filePath = flUpload.PostedFile.FileName; // getting the file path of uploaded file  
            ...
            if (flUpload.HasFile)
            {
                ...
                flUpload.PostedFile.SaveAs(Server.MapPath("~/Images/Courses/" + str));
                ...
                cmd.Parameters.AddWithValue("@file_path", imgUpload);
                //cmd.Parameters.Add("@name", SqlDbType.VarChar).Value = cname;
                //cmd.Parameters.Add("@description", SqlDbType.VarChar).Value = description;
                //cmd.Parameters.Add("@course_id", SqlDbType.VarChar).Value = course_id;
                //cmd.Parameters.Add("@file_path", SqlDbType.Binary).Value = bytes;
                cmd.Connection = con;
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
